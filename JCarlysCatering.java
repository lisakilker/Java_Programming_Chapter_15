...
public class JCarlysCatering extends JFrame implements ItemListener, ActionListener {
    ...
    public JCarlysCatering() {
        ...
        carlysHeaderLabel.setFont(new Font("Helvetica", Font.BOLD, 25));

        guestsPanel.setBackground(Color.ORANGE);
    ...
    public static void main(String[] args) {
        ...
        jCarlysCatering.setSize(640, 330);
